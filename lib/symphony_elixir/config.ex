defmodule SymphonyElixir.Config do
  ...
  defp validate_semantics(settings) do
    cond do
      ...
      settings.tracker.kind not in ["linear", "memory", "feishu"] ->
      ...
      settings.tracker.kind == "feishu" and not is_binary(settings.tracker.app_token) ->
        {:error, :missing_feishu_app_token}

      settings.tracker.kind == "feishu" and not is_binary(settings.tracker.table_id) ->
